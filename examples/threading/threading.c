...
void* threadfunc(void* thread_param)
{
    ...
    DEBUG_LOG("Waiting for %d ms before locking mutex", thread_func_args->wait_to_obtain_ms);
    ...
    DEBUG_LOG("Waiting for %d ms while locking mutex", thread_func_args->wait_to_release_ms);
